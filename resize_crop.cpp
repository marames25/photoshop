...
/*
Section:17, 18
Mariam Hesham Mohamed       ID:20230400  filters: gray scale
Nada Atef Ibrahim           ID:20230442  filters: invert and black and white
Maram Esmaiel Abdelfattah   ID:20231156  filters: rotation and inverse colors
*/
...
int main() {
    ...
    while (true) {
        ...
        cin >> op;
        while (op != "1" && op != "2" && op != "3" && op != "4" && op != "5" && op != "6" && op != "7" && op != "8" && op != "9" && op != "10" && op != "11" && op != "12" && op != "13" && op != "14")
        {
            cout << "please choose a valid input \n";
            cin >> op;
        }
        ...
        else if (op == "4")
        {
            ...
            cin >> choice;
            rotateImage(input_filename, choice);
            break;
            }
